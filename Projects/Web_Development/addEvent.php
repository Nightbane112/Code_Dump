...
<head>
    ...
    <![endif]-->
    <title>Site Administration - Adding Event</title>
</head>
<body>
...
<main id="mainContent">
    ...
    $addEventSQL = "INSERT INTO `AE_events` 
                    (`eventTitle`,`eventDescription`,`venueID`,`catID`,`eventStartDate`,`eventEndDate`,`eventPrice`)
                    VALUES
                    ('$eventTitle','$eventDesc','$venueID','$catID','$eventStartDate','$eventEndDate','$entryPrice')";

    // Use variable to determine transaction success
    $successTrans = $dbConn->query($addEventSQL);
    ...
    if ($successTrans === false) {
        ...
        echo "<p>Please <a href=\"addEventsForm.html\" tabindex='5' accesskey='t'>try again</a></p>\n";
    }
    else {
        echo "<p tabindex='4' accesskey='m'>The event has been successfully added.</p>\n";
    }
